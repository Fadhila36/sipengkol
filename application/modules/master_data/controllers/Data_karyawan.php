...
class Data_karyawan extends CI_Controller
{
    ...
    public function list_jabatan()
    {
        ...
        if ($this->input->post('divisi') != "") {
            $list_jabatan = [
                'STAFF' => 'Staff', 'HEAD' => 'Head', 'SPV' => 'Supervisor',
    ...
    public function tampildata()
    {
        ...
        foreach ($list as $data) {
            ...
            $tombol_action = (cek_akses_user()['edit'] == 1 ? '<a href="#" ><span class="badge badge-primary btn-edit" data-jenis_action="edit" data-nik="' . $data['nik'] . '" data-id="' . hash_id($data['nik']) . '">Edit</span></a>' : '') .
            ...
            $row = [
                'nik' => $data['nik'], 'level_user' => $data['level_user'], 'last_login' => $data['last_login'],
