...
<body>
  <section style="height: 100%; width: 100%; box-sizing: border-box; background-color: #232130">
    <style>
      ...
      .width-left-content-3-6 {
        width: 0%;
      }

      .width-right-content-3-6 {
        width: 100%;
        height: 100%;
      ...
      .caption-text-content-3-6 {
        font-size: 0.875rem;
        line-height: 1.75rem;
        color: #737182;
      }

      .input-label-content-3-6 {
        color: #D8D7DF;
        font-size: 1.125rem;
        line-height: 1.75rem;
        font-weight: 500;
      ...
      .div-input-content-3-6:focus-within {
        border: 1px solid #2EC49C;
        color: #D8D7DF;
      }

      .div-input-content-3-6 input::placeholder {
        color: #4E4B62;
      }

      .div-input-content-3-6:focus-within input::placeholder {
        color: #D8D7DF;
        outline: none;
      }

      .div-input-content-3-6:focus-within .icon-content-3-6 path {
        transition: 0.3;
        fill: #2EC49C;
      }

      .div-input-content-3-6 .icon-toggle-empty-3-6 path {
        transition: 0.3;
        fill: #2EC49C;
      }

      .input-field-content-3-6 {
        width: 100%;
        font-size: 1rem;
        line-height: 1.5rem;
        font-weight: 300;
      ...
      .input-field-content-3-6:focus {
        outline: none;
      }

      .forgot-password-content-3-6 {
        font-size: 0.875rem;
        line-height: 1.25rem;
        color: #737182;
        transition: 0.3s;
      ...
      .forgot-password-content-3-6:hover {
        color: #D8D7DF;
        text-decoration: none;
      }

      .btn-fill-content-3-6 {
      ...
      .green-bottom-caption-content-3-6 {
        color: #2EC49C;
        font-weight: 500;
      }

      .green-bottom-caption-content-3-6:hover {
        color: #2EC49C;
        cursor: pointer;
    ...
    <div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
      <div class="position-relative d-none d-lg-block h-100 width-left-content-3-6">
        <img class="position-absolute img-fluid centered-content-3-6" src="http://api.elements.buildwithangga.com/storage/files/2/assets/Empty%20State/EmptyState3/Empty-3-6.png" alt="">
      </div>
      <div class="d-flex mx-auto align-items-left justify-content-left width-right-content-3-6">
        <div class="right-content-3-6">
          ...
          <h3 class="title-text-content-3-6">Log In SIPENGKOL</h3>
          <p class="caption-text-content-3-6">Selamat datang di web Sistem Pengelolaan Karyawan Online.</p>

          <form style="margin-top: 1.5rem;" action="" method="post">

            <div style="margin-bottom: 1.75rem;">
              <label for="" class="d-block input-label-content-3-6">Nama Divisi</label>
              <div class="d-flex w-100 div-input-content-3-6">
                <svg class="icon-content-3-6" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input class="input-field-content-3-6 <?= (form_error('nik') ? "is-invalid" : "") ?>" type="text" name="nik" value="<?= set_value('nik') ?>" id="" placeholder="Nama Divisi" autocomplete="on" required>
              </div>
            </div>
            <?= (form_error('nik') ? form_error('nik') : "") ?>

            <div style="margin-top: 1rem;">
              <label for="" class="d-block input-label-content-3-6">Password</label>
              <div class="d-flex w-100 div-input-content-3-6">
                <svg class="icon-content-3-6" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input class="input-field-content-3-6 <?= (form_error('password') ? "is-invalid" : "") ?>" type="password" value="<?= set_value('password') ?>" name="password" id="" placeholder="Your Password" minlength="6" required>
                <div>
            ...
            <div class="text-right" style="margin-top: 0.75rem;">
              <a href="#" class="forgot-password-content-3-6 font-italic">Forgot Password?</a>
            </div>
            <button class="btn btn-fill-content-3-6 d-block w-100" type="submit">Log In To My Account</button>
          </form>
        </div>
      </div>
