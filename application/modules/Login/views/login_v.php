        ...
        <div class="right-content-3-6">
          ...
          <form style="margin-top: 1.5rem;" action="" method="post">
            ...
            <div style="margin-bottom: 1.75rem;">
              <label for="" class="d-block input-label-content-3-6">Nik</label>
              <div class="d-flex w-100 div-input-content-3-6">
                ...
                <input class="input-field-content-3-6 <?= (form_error('nik') ? "is-invalid" : "") ?>" type="text" name="nik" value="<?= set_value('nik') ?>" id="" placeholder="Nik" autocomplete="on" required>
              </div>
            </div>
